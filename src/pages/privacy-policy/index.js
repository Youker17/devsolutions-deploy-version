...
<section>
  <div class="flex flex-col items-center justify-center px-5 md:px-10">
    <div class="flex h-auto min-w-[100vw] flex-col items-center justify-end bg-[#ffffff] py-6 md:h-64">
      <div class="flex flex-col items-center gap-y-4 py-5">
        <h1 class="text-3xl font-bold md:text-5xl font-display">PRIVACY & POLICY</h1>
